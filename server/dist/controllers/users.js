...
var signin = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, email, password, existingUser, isPasswordCorrect, token, error_1;
        ...
        switch (_b.label) {
            ...
            case 3:
                ...
                token = jsonwebtoken_1.default.sign({
                    ...
                    id: existingUser._id,
                }, process.env.UUID_SECRET, { expiresIn: 3600 });
                return [2 /*return*/, res.status(200).json({ result: existingUser, token: token })];
            case 4:
                error_1 = _b.sent();
                // 서버에서 발생한 에러
...
var signup = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, email, password, confirmPassword, firstName, lastName, existingUser, hashedPw, result, token, error_2;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
